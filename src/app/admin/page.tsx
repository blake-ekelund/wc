    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 flex flex-col min-h-screen min-w-0">
        ...
        <header className="sticky top-0 z-20 bg-white border-b border-gray-200 h-14 flex items-center px-4 sm:px-6 gap-3 shrink-0">
          ...
          <button
            onClick={() => { loadConversations(); loadOverview(); loadDemoSessions(); loadActivity(); loadPeople(); loadAnnouncements(); }}
          ...
          {section === "overview" && (
            <div className="p-4 sm:p-6 max-w-7xl space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <KpiCard icon={Users} iconBg="bg-gray-100" iconColor="text-gray-600" value={totalContacts} label="CRM Contacts" />
