...
export default function PipelineView({ contacts, stages, onSelectContact, ownerLabels }: PipelineViewProps) {
  ...
  return (
    <div className="p-4 lg:p-6 max-w-7xl">
      ...
      {/* Filters row */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-4" aria-label="Pipeline filters">
      ...
      <div className="bg-white rounded-xl border border-border overflow-hidden">
        <table className="w-full" role="table" aria-label="Pipeline deals">
          <thead>
